...
export const metadata: Metadata = {
  title: "KI-Integration & Automatisierung für Unternehmen NRW | 2fastmedia Dinslaken",
  description:
  ...
  openGraph: {
    title: "KI-Integration & Automatisierung für Unternehmen NRW | 2fastmedia",
    description:
...
const faqSchema = {
  ...
  mainEntity: [
    ...
    {
      "@type": "Question",
      name: "Welche KI-Tools nutzt 2fastmedia?",
      acceptedAnswer: {
        "@type": "Answer",
        ...
        <div className="max-w-4xl mx-auto">
          <AnimateOnScroll>
            ...
            <div className="grid md:grid-cols-2 gap-8 text-[#A0A0A0] text-sm leading-relaxed">
              ...
              <div className="space-y-4">
                <p>
                  Wir bei 2fastmedia machen aus dem Hype echte Praxis. Wir schauen uns an, wie du heute arbeitest, und finden die Stellen wo Automatisierung am meisten bringt. Kein technisches Kauderwelsch – konkrete Lösungen, die du morgen nutzen kannst.
                </p>
                <p>
